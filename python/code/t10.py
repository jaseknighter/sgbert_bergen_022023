...
parser.add_argument("--skipMidiSequence", default=False,
    help="skip the midi sequence file")
...
caps[11].append(SensorParam(11, 0.05, 0.2, 5, increasing=True))
...
knobs_to_osc1[0] = (0,'26')
knobs_to_osc1[1] = (1,'28')
knobs_to_osc1[2] = (2,'31')
knobs_to_osc1[3] = (3,'33')
knobs_to_osc1[4] = (4,'36')
knobs_to_osc1[5] = (5,'43')
...
while True:
    ...
    try:
        ...
        print("args.skipMidiSequence", args.skipMidiSequence) 
        while True:
            ...
            ticks_to_play = 0
            while True and args.skipMidiSequence == False and note_idx < len(notes):
