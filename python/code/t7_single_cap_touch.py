...
caps[3].append(SensorParam(3, 0, 0.03, 1, increasing=True))
caps[4].append(SensorParam(4, 0, 5, 2, increasing=True))
...
caps[10].append(SensorParam(10, 0, 0.9, 1, increasing=True))
caps[11].append(SensorParam(11, 0, 0.9, 1, increasing=True))
