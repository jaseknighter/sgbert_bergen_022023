...
caps[10].append(SensorParam(10, 0.05, 0.5, 5, increasing=True))
caps[11].append(SensorParam(11, 0.05, 0.5, 5, increasing=True))
                    ...
                    for cap in cap_list:
                        ...
                        if knob is TEMPO and touched > 0:
                          ...
                          if path == "/quality":
                            ...
                            client.send_message("/params/vol 1", 0.05)
                            client.send_message("/params/vol 2", 0.05)
                            client.send_message("/params"+path, minval)
                          elif path:
                            client.send_message("/params"+path, minval)
